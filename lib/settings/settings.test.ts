...
describe("local settings", () => {
  it("loads valid settings", () => { const value = { ...DEFAULT_SETTINGS, defaultAuditMode: "site" as const, historyLimit: 50 as const }; expect(loadSettings({ getItem: () => JSON.stringify(value) })).toEqual(value); });
